...
export default function ArchitectureAISection() {
  ...
  return (
    <section style={{ background: "#FFF9F2", borderTop: "1px solid hsl(var(--paper-mid))", borderBottom: "1px solid hsl(var(--paper-mid))" }} className="py-20 md:py-28">
      <div className="mx-auto max-w-[1280px] px-6 lg:px-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
        {/* Left */}
        <div>
