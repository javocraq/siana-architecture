  ...
  return (
    ...
    >
      <div className="max-w-[640px]">
        <p
          className="font-mono uppercase text-accent-terra mb-4"
      ...
      <Link
        to="/cities"
        className="font-mono uppercase inline-flex items-center gap-3 text-white hover:gap-4 transition-all"
        style={{
